...
public class BoxTransactionalAPIConnectionTest {
    ...
    public void attemptingToCreateConnectionWithClientIDThrowsError() {
        new BoxTransactionalAPIConnection("clientId", "clientSecret");
    }

    @Test(expected = UnsupportedOperationException.class)
    @Category(UnitTest.class)
    public void attemptingToCreateConnectionWithClientIDAndAccessTokenThrowsError() {
        new BoxTransactionalAPIConnection("clientId", "clientSecret", "accessToken", "refresh");
    }

    @Test(expected = UnsupportedOperationException.class)
    @Category(UnitTest.class)
    public void attemptingToCreateConnectionWithClientIDAndAuthCodeThrowsError() {
        new BoxTransactionalAPIConnection("clientId", "clientSecret", "authCode");
    }
